...
colnames(data)[11] = "Drought_Level"
...
# 0.8377050 0.7655976 0.8681324 0.9011004 
...
# Cluster Analysis: 7
hc_7 <- agnes(distance_matrix, method = "ward")
pltree(hc_7, cex = 0.5, hang = -1, main = "Dendrogram")
rect.hclust(hc_7, k = 7, border = 2:6)
sub_grp_7 <- cutree(hc_7, k = 7)
table(sub_grp_7)

hc_2 <- agnes(distance_matrix, method = "ward")
pltree(hc_2, cex = 0.5, hang = -1, main = "Dendrogram")
rect.hclust(hc_2, k = 2, border = 2:6)
sub_grp_2 <- cutree(hc_2, k = 2)
table(sub_grp_2)
...
dunn(distance = distance_matrix, sub_grp_7)
# 0.2590434
